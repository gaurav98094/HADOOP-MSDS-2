...
public class C45 extends Configured implements Tool {
  ...
  public static void writeRuleToFile(String text) {
	    try {
	    	...
	    	BufferedWriter bw = new BufferedWriter(new FileWriter(new File("/home/hdoop/hadoop-3.2.2/sbin/pack/rule.txt/"), true));    
	    	bw.write(text);
	            bw.newLine();
	            bw.close();
	    } catch (Exception e) {
  ...
  public int run(String[] args) throws Exception {
    ...
    FileOutputFormat.setOutputPath(conf, new Path(args[1]+current_index));
